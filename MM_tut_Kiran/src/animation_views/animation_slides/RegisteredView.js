...
define(function(require, exports, module) {
   ...
   RegisteredView.prototype.returnCaptionArray = function() {
   		var captionText = ["Caption: Great! Back at Hari’s clinic, his computer receives this text message, and Medic Mobile creates a new record for Maya. Hari can see all new registered patients in the “Reports” tab of the software."];
   		return captionText;	
   }
