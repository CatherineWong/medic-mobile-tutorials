...
define(function(require, exports, module) {
	...
	var captionText = [
		[
			...
			"5) Nick",
			"6) NICK",
			"Before Medic Mobile, Lalita used paper records to keep track of the pregnant women in her village.",
			"Dealing with these paper records alone could take up to 11-15 days a month.",
			"9) nhershey",
			"10) DDDDOOOONNNNEEEE!"
		],
		[
